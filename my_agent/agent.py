...
search_agent = Agent(
    ...
    instruction='You are Aura, a highly intelligent AI assistant equipped with real-time Google Search capabilities. Search Google to get live, up-to-date information, news, and facts for the user. Be exceptionally smart and helpful.',
    tools=[google_search]
)
